...
const CartProduct = ({ id, name, image, category, qty, total, price }) => {
  ...
  return (
    <div className="bg-blue-200  bg-opacity-30 backdrop-blur-lg drop-shadow-lg  p-2 flex gap-4 rounded ">
      <div className=" w-full rounded-lg bg-opacity-30 backdrop-blur-lg drop-shadow-lg  shadow-md  min-w-[200px] max-w-[200px] p-1 bg-white rounded overflow-hidden">
